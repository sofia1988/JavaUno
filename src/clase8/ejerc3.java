...
public class ejerc3 {
    ...
    public static void main(String[] args) {
        ServicioPersonaejer3 servicio = new ServicioPersonaejer3();

        //Personaejerc3 persona1 = servicio.crearPersona();
        

        /*  Personaejerc3[] x =new Personaejerc3[4];
      for (int i = 0; i < x.length; i++) {
      x [i] = servicio.crearPersona();
      servicio.esMayorDeEdad(x[i]);
      servicio.calcularIMC(x[i]);
     }*/
 /*for (int i = 0; i < x.length; i++) {
